        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Link href="/catalogo">
                <Button className="bg-gsn-green hover:bg-gsn-green-dark text-white">
            ...
            <div className="space-y-3">
              {filtered.map((order) => (
                <Link key={order.orderId} href={`/pedidos/${order.sapDocEntry}`}>
                  <Card className="transition-all hover:shadow-md hover:border-gsn-green/20 cursor-pointer">
