...
As requisições do frontend (`http://31.97.174.120:8080`) para a API (`http://localhost:8000`) estavam falhando devido a:
...
< access-control-allow-origin: http://31.97.174.120:8080
