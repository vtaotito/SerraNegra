/**
 * Script de conferência: valida conexão SAP B1 e lista pedidos da base REDACTED_COMPANY_DB.
 *
 * Para rodar:
...
async function main() {
  ...
  try {
    ...
    if (orders.length === 0) {
      console.log("⚠️  Nenhum pedido encontrado na base REDACTED_COMPANY_DB.");
