/**
 * Teste do Mock SAP B1 — Somente dados reais da SBO_GARRAFARIA_TST
 *
 * Valida:
...
async function main() {
  console.log("\n" + DIVIDER);
  console.log("  SAP B1 Mock — Dados Reais SBO_GARRAFARIA_TST");
  console.log(DIVIDER + "\n");
  ...
  console.log("\n✅ Todos os dados são reais da SBO_GARRAFARIA_TST!\n");
}
