            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={monthlyData}>
                  ...
                  <YAxis yAxisId="left" tick={{ fill: "#78696c", fontSize: 11 }}
                  ...
                  <Bar yAxisId="left" dataKey="fat" name="Faturamento" radius={[4, 4, 0, 0]}>
                    {monthlyData.map((d, i) => (
                      <Cell key={i} fill={d.fat >= medianMonth ? "#A81C2C" : "#e5dfe1"} />
                    ))}
                  </Bar>
            ...
            <div className="h-72">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={weekdayData}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e5dfe1" />
                  <XAxis dataKey="name" tick={{ fill: "#78696c", fontSize: 12 }} />
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={groupData.slice(0, 12)} layout="vertical" barCategoryGap="15%">
                    ...
                    <XAxis type="number" tick={{ fill: "#78696c", fontSize: 11 }}
                      tickFormatter={(v: number) => v >= 1000 ? `${(v / 1000).toFixed(0)}k` : String(v)} />
                    <YAxis dataKey="group" type="category" tick={{ fill: "#78696c", fontSize: 11 }} width={40} />
                    <Tooltip content={<ChartTooltip />} />
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={vendorData} layout="vertical" barCategoryGap="15%">
                  ...
                  <XAxis type="number" tick={{ fill: "#78696c", fontSize: 11 }}
                    tickFormatter={(v: number) => v >= 1000 ? `${(v / 1000).toFixed(0)}k` : String(v)} />
                  <YAxis dataKey="name" type="category" tick={{ fill: "#78696c", fontSize: 11 }} width={100}
