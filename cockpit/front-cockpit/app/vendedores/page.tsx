              ...
              {filtered.length === 0 ? (
                ...
                <tr key={r.code} className="hover:bg-white/5">
                  ...
                  <td className="px-4 py-3 text-center">
                    <span className={`inline-block px-2 py-0.5 rounded-full text-xs ${r.active ? "bg-emerald-500/15 text-emerald-400" : "bg-red-500/15 text-red-400"}`}>{r.active ? "Ativo" : "Inativo"}</span>
                  </td>
                </tr>
              ))}
            </tbody>
