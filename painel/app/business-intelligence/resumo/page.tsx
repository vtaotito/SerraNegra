          ...
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart data={monthlyTrend}>
                ...
                <YAxis yAxisId="left" tick={chartAxisTick("sm")}
                  tickFormatter={(v: number) => formatYAxisCompact(v)} />
                <YAxis yAxisId="right" orientation="right" tick={{ ...chartAxisTick("sm"), fill: "#059669" }}
                  tickFormatter={(v: number) => formatYAxisCompact(v)} />
                <Tooltip content={<BiChartTooltip variant="cockpit" />} />
                <Bar yAxisId="left" dataKey="fat" name="Faturamento" radius={[3, 3, 0, 0]} fill={CHART_SERIES_PRIMARY} />
          ...
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={topClients} layout="vertical" barCategoryGap="15%">
                ...
                <XAxis type="number" tick={chartAxisTick("sm")}
                  tickFormatter={(v: number) => formatYAxisCompact(v)} />
                <YAxis dataKey="name" type="category" tick={chartAxisTick("sm")} width={100} />
                <Tooltip content={<BiChartTooltip variant="cockpit" />} />
