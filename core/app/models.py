...
class InventoryStock(Base):
    ...
    available: Mapped[float] = mapped_column(Numeric(18, 6), nullable=False, default=0)
    min_stock: Mapped[float] = mapped_column(Numeric(18, 6), nullable=False, default=0)
    max_stock: Mapped[float] = mapped_column(Numeric(18, 6), nullable=False, default=0)
    uom: Mapped[str | None] = mapped_column(String(64), nullable=True)
    avg_price: Mapped[float] = mapped_column(Numeric(18, 6), nullable=False, default=0)
    last_purchase_price: Mapped[float] = mapped_column(Numeric(18, 6), nullable=False, default=0)
    last_purchase_date: Mapped[str | None] = mapped_column(String(32), nullable=True)
    last_sale_date: Mapped[str | None] = mapped_column(String(32), nullable=True)
    gross_weight: Mapped[float] = mapped_column(Numeric(18, 6), nullable=False, default=0)
    lead_time: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    item_group_code: Mapped[int | None] = mapped_column(Integer, nullable=True)
